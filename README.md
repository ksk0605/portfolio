...
## 👋 소개
<a href="https://youtu.be/rFnh9icyTRk?feature=shared">
  <img src="./assets/woowa_낭만개발자%20썸네일.png" width="50%" alt="낭만 개발자 영상 썸네일"/>
</a>

**자바, 스프링 기반의 백엔드 개발을 주력**으로 삼는 개발자로,  
개발을 통한 자아 실현을 꿈꾸며 이것을 상징하는 **‘낭만 개발자’** 라는 키워드로 자신을 소개하기를 즐깁니다.  
서비스가 사용자에게 전달되지 않으면 우울감을 느낄 정도로 **내가 만든 제품에 진심**이며  
더 나은 서비스를 위해 **최적화된 도메인 모델 설계와 좋은 테스트에 대해 고민**하길 즐깁니다.
